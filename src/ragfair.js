...
function prepareCatItems(categ)
{
	...
	if(cat_cloth.indexOf(categ.ParentId) != -1 || cat_maps.indexOf(categ.ParentId) != -1) {
		multiplier = 1.5;	flag_itsOKtoAdd = true;
